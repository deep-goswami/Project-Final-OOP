...
<head>
  ...
  <title>Doctor appoitment system</title>
  <!-- plugins:css -->
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="<?php echo e(URL::to('admin_dashboard')); ?>"><img src=" " alt="Logo"></a>
      </div>
        ...
        <ul class="navbar-nav ml-lg-auto">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown mail-notification" aria-labelledby="MailDropdown">
              <a class="dropdown-item" href="<?php echo e(URL::to('/veiwprofile')); ?>">
              ...
              <a class="dropdown-item" href="<?php echo e(URL::to('/setting')); ?>">
                <div class="sender-img">
                  <img src="http://via.placeholder.com/47x47" alt="">
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(URL::to('/totalpatient')); ?>">
                <i class="mdi mdi-gauge menu-icon"></i>
                <span class="menu-title">Total Patient</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo e(URL::to('/appointment')); ?>">
               ...
               <li class="nav-item">
              <a class="nav-link" href="<?php echo e(URL::to('/doctor')); ?>">
                <i class="mdi mdi-puzzle menu-icon"></i>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/boxed-layout.html">Add Doctor</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/rtl-layout.html">Doctor Profile</a>
                  </li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="sidebar_layouts">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/compact-menu.html">Prescription</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/sidebar-collapsed.html">Good Treatment</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/sidebar-hidden.html">Available Doctor</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/layout/sidebar-hidden-overlay.html">Available Nurse</a>
                  </li>
                  <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="advancedSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/forms/form-addons.html">Prescription</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/forms/form-picker.html">Good Treatment</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/forms/bt-select-splitter.html">Available Doctor</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/forms/icheck.html">Available Nurse</a>
                  </li>
                </ul>
              </div>
            </li>
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="float-right">
                <a href="#">Deep Goswami</a> &copy; 2018
            </span>
          </div>
        </footer>
        <!-- partial -->
